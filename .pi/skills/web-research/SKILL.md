---
name: web-research
description: Local on-demand web search via WebX (SearXNG + safe reader) — search is candidates, read is evidence via trafilatura/pypdf with SSRF pinning. Use when outside/current info materially helps (versions, docs, recent changes). Requires explicit /skill:web-research.
